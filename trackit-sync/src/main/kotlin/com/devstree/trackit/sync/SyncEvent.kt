 ...
 *
 * [TrackItSync.syncNow] already returns the outcome of a drain the host asked for. This
 * exists for the drains it did not: [TrackItSync.requestSync] hands the work to WorkManager,
 ...
 *
 * Deliberately **not** a case on `TrackItEvent`. That flow belongs to `trackit-core`, which
