...
private const val WHY =
    "TrackIt records your route while the app is closed or the screen is off. " +
...
private fun guideFor(step: BackgroundStep): BackgroundGuide = when (step) {
    ...
    BackgroundStep.SETTINGS -> BackgroundGuide(
        ...
        steps = listOf(
            "Tap \"Open settings\" below — this opens TrackIt's App info page.",
            "Tap \"Permissions\".",
            "Tap \"Location\".",
            "Select \"Allow all the time\".",
            "Turn on \"Use precise location\" if it is shown.",
            "Press Back to return to TrackIt.",
        ),
