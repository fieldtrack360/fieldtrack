# TrackIt core — rules a consuming app inherits.
#
...
# specific rather than a `-keep class com.devstree.trackit.** { *; }`. A blanket keep on
...
#                          covers TrackItDatabase and the generated `_Impl` it loads.
