...
public class TrackingService : LifecycleService() {
     ...
     */
    private val graph by lazy { TrackItGraph.get(applicationContext) }

    private val events: MutableSharedFlow<TrackItEvent> get() = graph.events
    ...
    private fun startSupervision() {
        lifecycleScope.launch {
            val config = configRepository.load() ?: TrackItConfig()
    ...
    public companion object {
        ...
        public const val ACTION_RESUME: String = "com.devstree.trackit.RESUME"
        public const val ACTION_STOP: String = "com.devstree.trackit.STOP"
