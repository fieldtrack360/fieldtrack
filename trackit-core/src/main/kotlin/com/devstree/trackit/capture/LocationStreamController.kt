...
import com.devstree.trackit.data.location.LocationRequests
...
internal class LocationStreamController(
    ...
    fun start(config: TrackItConfig, vehicular: Boolean = false) {
        this.config = config
    ...
    /**
     * Called by [com.devstree.trackit.motion.MotionController] as motion state changes.
