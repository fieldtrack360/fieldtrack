 ...
 * lets [com.devstree.trackit.geo.filter.AcceptancePipeline] stay a pure function of
...
public data class IngestContext(
     ...
     * [com.devstree.trackit.geo.filter.TrackItConstants] value, for the same reason
     * [mockPolicy] is: it is a policy the host owns, not a number the engine tuned. The
     * engine's own floors on the comparison stay in `TrackItConstants` (EC-45).
     */
