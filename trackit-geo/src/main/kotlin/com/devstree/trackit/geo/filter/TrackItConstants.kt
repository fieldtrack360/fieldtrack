 ...
 */
public data class TrackItConstants(
    // ── timing ────────────────────────────────────────────────────────────────
     ...
     * config and arrives on [com.devstree.trackit.geo.model.IngestContext].
     *
     ...
     * ([com.devstree.trackit.geo.motion.TurnDetector]).
     *
    ...
    public companion object {
        public val Default: TrackItConstants = TrackItConstants()
    }
}
