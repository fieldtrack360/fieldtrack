...
import com.devstree.trackit.geo.model.PipelineResult
...
import com.devstree.trackit.geo.util.Uuids
...
public class AcceptancePipeline(
    private val c: TrackItConstants = TrackItConstants.Default,
) {
     ...
     *
     * The displacement fallback is deliberately floored at [TrackItConstants.bearingCaptureMinDist]:
     ...
     * be plumbed in from [com.devstree.trackit.geo.motion.TurnDetector], and this stays
