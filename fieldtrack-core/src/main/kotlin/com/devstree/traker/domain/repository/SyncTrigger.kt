 ...
 *
 * The mirror of [PendingUploadStore]: that seam lets `fieldtrack-sync` read the queue, this
 ...
 * network code at all.
 *
 * Registered by `fieldtrack-sync` when `SyncConfig.autoSync` is on, and cleared when it is
