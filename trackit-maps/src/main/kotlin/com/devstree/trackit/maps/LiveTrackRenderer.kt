package com.devstree.trackit.maps
...
import com.devstree.trackit.geo.plot.PuckAnimation
import com.devstree.trackit.geo.plot.model.LiveTrackUpdate
import com.devstree.trackit.geo.plot.model.PuckState
...
/**
 * Draws the live surface — [LiveTrackUpdate] frames from `TrackIt.liveTrack()` — the
